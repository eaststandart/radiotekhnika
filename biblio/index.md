...
<a href="rostovcev-n-n-risovanie-1957.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Основа визуализации и пространственного мышления. Развитие наблюдательности и навыков графического изображения предметов — база, необходимая инженеру для зарисовки схем, понимания чертежей и проектирования новых устройств.</p>
	</div>
</a>
