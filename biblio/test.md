...
<a href="materialy-dlya-samostoyatelnogo-izucheniya-osnov-elektroniki.html" class="compact-card">
    ...
    <div class="compact-info">
        ...
        <p class="compact-desc">Самостоятельное изучение основ электроники детьми 8-16 лет. Для овладения техническими знаниями практические занятия должны проводиться регулярно, не реже трёх раз в неделю.</p>
    </div>
</a>
