...
<a href="svoren-r-a-elektronika-shag-za-shagom-1991.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Фундаментальный курс практической электроники. Понятное объяснение теории через эксперименты и живые примеры — от принципа работы до создания сложных электронных систем.</p>
	</div>
</a>
