...
<a href="chernenko-g-t-puteshestvie-v-stranu-robotov-1977.html" class="item-card">
	...
	<div class="item-info">
		<h3>Путешествие в страну роботов. Рассказы об автоматике.</h3>
...
<a href="pchyolko-a-s-arifmetika-dlya-nachalnoj-shkoly-1955.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Фундаментальная база для инженерных расчетов. Классические учебники по арифметике, помогающие освоить «язык математики», необходимый для  проектирования и понимания работы электрических схем и цепей.</p>
	</div>
</a>
