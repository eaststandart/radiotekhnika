...
и без v но последняя картинка вертикальная
...
3-3-1 Простые горизонтальные c параметром v по 2

![](github/eaststandart.github.io/faire/muzykalnyj-karandash/muzykalnyj-karandash-19.webp)
![{v}](github/eaststandart.github.io/faire/muzykalnyj-karandash/muzykalnyj-karandash-02.webp)
![{v}](github/eaststandart.github.io/faire/muzykalnyj-karandash/muzykalnyj-karandash-02.webp)

3-3-2 Простые горизонтальные c параметром v по 3
...
3-3-3 Простые горизонтальные c параметром v по 3
...
4-1 Группа fig картинок  с подписью

![{fig}|Рис. 3 – Электроны в электрической цепи устремляются от «минуса» к «плюсу»|500](github/eaststandart.github.io/faire/muzykalnyj-karandash/muzykalnyj-karandash-19.webp)
