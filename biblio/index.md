...
<a href="materialy-dlya-samostoyatelnogo-izucheniya-osnov-elektroniki.html" class="item-card">
	<img src="img/materialy-dlya-samostoyatelnogo-izucheniya-osnov-elektroniki.webp" alt="Обложка" class="item-image">
	<div class="item-info">
		<h3>Материалы для самостоятельного изучения основ электроники</h3>
		<span class="item-subtext">Автор</span>
		<p>Первоначальный материал для самостоятельного изучения основ электроники детьми 8-16 лет.</p>
	</div>
</a>
...
<a href="chernenko-g-t-puteshestvie-v-stranu-robotov-1977.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Введение в автоматику и робототехнику. Первые шаги в изучении механизмов и систем управления. Развитие инженерного мышления в младшем и среднем возрасте.</p>
	</div>
</a>
...
<a href="borisov-v-g-enciklopediya-yunogo-radiolyubitelya-konstruktora-2001.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Классика инженерной литературы. Фундаментальные знания о радиосвязи и принципах работы электронных устройств и компонентов.</p>
	</div>
</a>
...
<a href="zak-a-z-intellektika-2024.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Курс развития мышления. Задачи на выработку навыков анализа и поиска решений, необходимых для проектирования собственных инженерных устройств.</p>
	</div>
</a>
...
<a href="rostovcev-n-n-risovanie-1957.html" class="item-card">
	...
	<div class="item-info">
		...
		<p>Основа визуализации и пространственного мышления. Развитие навыков графического изображения предметов — база, необходимая инженеру для зарисовки схем, понимания чертежей и проектирования новых устройств.</p>
	</div>
</a>
