...
<a href="svoren-r-a-elektronika-shag-za-shagom-1991.html" class="compact-card">
    ...
    <div class="compact-info">
        ...
        <p class="compact-desc">Фундаментальный курс практической электроники — от принципа работы до создания сложных электронных систем.</p>
    </div>
</a>
...
<a href="borisov-v-g-enciklopediya-yunogo-radiolyubitelya-konstruktora-2001.html" class="compact-card">
    ...
    <div class="compact-info">
        ...
        <p class="compact-desc">Фундаментальные знания о радиосвязи, принципах работы электронных устройств и компонентов.</p>
    </div>
</a>
